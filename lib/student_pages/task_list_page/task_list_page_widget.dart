...
class TaskListPageWidget extends StatefulWidget {
  const TaskListPageWidget({
    super.key,
    required this.receivedFromClass,
  });

  final DocumentReference? receivedFromClass;

  static String routeName = 'TaskListPage';
  static String routePath = '/taskListPage';
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxzdHVkeXxlbnwwfHx8fDE3NDE4MzM5ODl8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                    width: double.infinity,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Text(
                                                                              dateTimeFormat("d/M h:mm a", listViewQuizzesRecord.dueDate!),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'Plus Jakarta Sans',
                                                                                    letterSpacing: 0.0,
                                                                                  ),
