...
import 'add_students_model.dart';
export 'add_students_model.dart';

class AddStudentsWidget extends StatefulWidget {
  const AddStudentsWidget({
    super.key,
...
class _AddStudentsWidgetState extends State<AddStudentsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStudentsModel());
        ...
        children: [
          ...
          StreamBuilder<List<StudentsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<StudentsRecord> listViewStudentsRecordList = snapshot.data!;
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, listViewIndex) {
                  ...
                  return InkWell(
                    ...
                    onTap: () async {
                      await widget.classID!.update({
                        ...mapToFirestore(
                          {
                            'studentsID': FieldValue.arrayUnion(
                                [listViewStudentsRecord.reference.id]),
                          },
                        ),
                      });

                      await listViewStudentsRecord.reference
