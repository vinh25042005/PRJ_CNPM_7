import '/components/right_answer_widget.dart';
...
export 'scratchpad_model.dart';

class ScratchpadWidget extends StatefulWidget {
  const ScratchpadWidget({super.key});

  static String routeName = 'Scratchpad';
  static String routePath = '/scratchpad';
...
class _ScratchpadWidgetState extends State<ScratchpadWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScratchpadModel());
